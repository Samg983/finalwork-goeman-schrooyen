...
public class Database {
	private static String locatieMysqlServer = "jdbc:mysql://dt5.ehb.be:3306/CP3_DBDEMO";
	private static String gebruikersnaam = "CP3_STD";
	private static String wachtwoord = "SQp5sT";
